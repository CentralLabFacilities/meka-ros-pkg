"""autogenerated by genmsg_py from M3JointArrayCmdRequest.msg. Do not edit."""
import roslib.message
import struct


class M3JointArrayCmdRequest(roslib.message.Message):
...
"""autogenerated by genmsg_py from M3JointArrayCmdResponse.msg. Do not edit."""
import roslib.message
import struct


class M3JointArrayCmdResponse(roslib.message.Message):
...
class M3JointArrayCmd(roslib.message.ServiceDefinition):
