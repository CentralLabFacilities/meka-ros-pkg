/**
 * @file /include/meka_velocity_smoother/velocity_smoother_nodelet.hpp
 *
...
#ifndef MEKA_VELOCITY_SMOOTHER_HPP_
#define MEKA_VELOCITY_SMOOTHER_HPP_
...
private:
  ...
  double last_acc_vx, last_acc_vy, last_acc_w;
  ...
  ** Dynamic Reconfigure
  **********************/
  dynamic_reconfigure::Server<meka_velocity_smoother::paramsConfig> *             dynamic_reconfigure_server;
  dynamic_reconfigure::Server<meka_velocity_smoother::paramsConfig>::CallbackType dynamic_reconfigure_callback;
  void reconfigCB(meka_velocity_smoother::paramsConfig &config, uint32_t unused_level);
};

} // meka_namespace velocity_smoother

#endif /* MEKA_VELOCITY_SMOOTHER_HPP_ */
